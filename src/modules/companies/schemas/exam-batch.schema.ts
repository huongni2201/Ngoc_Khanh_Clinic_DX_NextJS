...
export const examBatchItemFormSchema = z.object({
...
export type ExamBatchItemFormValue = z.infer<typeof examBatchItemFormSchema>

export const createExamBatchSchema = z
  .object({
    ...
    items: z.array(examBatchItemFormSchema),
  })
...
export type CreateExamBatchFormValues = z.infer<typeof createExamBatchSchema>
