...
export function EncounterLabOrdersView({ data, onViewDetail }: EncounterLabOrdersViewProps) {
  const { labOrders, encounter, patient } = data
      ...
      <div className="rounded-lg border border-border bg-card p-6 ">
        ...
        <div className="mt-4 flex items-center gap-3 rounded-lg border border-primary/20 bg-primary/5 px-4 py-3 text-xs text-primary">
          ...
          <p>
            ...
            <strong className="font-semibold">{encounter.encounterCode}</strong> ({encounter.examDate.split(" ")[0]}) của bệnh nhân{" "}
