...
export function EncounterSummaryView({ data, onNavigateTab }: EncounterSummaryViewProps) {
  ...
  const { vitalSigns, physicalExamFindings } = clinicalRecord
        ...
        <div className="rounded-lg border border-border bg-card p-6 ">
          ...
          <div className="mt-5 space-y-4 text-xs">
            ...
            <div className="rounded-lg bg-muted/40 p-3.5 border border-border/50">
              <p className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
                Bệnh sử hiện tại & Triệu chứng khởi phát
              </p>
              <p className="mt-1 text-xs text-foreground/90 leading-relaxed">
                {clinicalRecord.historyOfPresentIllness}
            </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                {clinicalRecord.pastMedicalHistory}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-border bg-card p-6 ">
          ...
          <div className="mt-4 grid grid-cols-3 sm:grid-cols-6 gap-2.5">
            ...
            <div className="rounded-lg border border-border/70 bg-background p-2.5 flex flex-col justify-between">
              ...
              <div className="mt-1">
                <span className="text-lg font-bold tracking-tight text-foreground">{vitalSigns.heartRate}</span>
            ...
            <div className="rounded-lg border border-border/70 bg-background p-2.5 flex flex-col justify-between">
              ...
              <div className="mt-1">
                <span className="text-base font-bold tracking-tight text-foreground">{vitalSigns.bloodPressure}</span>
            ...
            <div className="rounded-lg border border-border/70 bg-background p-2.5 flex flex-col justify-between">
              ...
              <div className="mt-1">
                <span className="text-lg font-bold tracking-tight text-foreground">{vitalSigns.temperature}</span>
            ...
            <div className="rounded-lg border border-border/70 bg-background p-2.5 flex flex-col justify-between">
              ...
              <div className="mt-1">
                <span className="text-lg font-bold tracking-tight text-foreground">{vitalSigns.respiratoryRate}</span>
            ...
            <div className="rounded-lg border border-border/70 bg-background p-2.5 flex flex-col justify-between">
              ...
              <div className="mt-1 flex items-baseline gap-1">
                <span className="text-lg font-bold tracking-tight text-foreground">{vitalSigns.bmi}</span>
                <span className="text-[10px] font-medium text-status-success">
                  {vitalSigns.bmiClassification}
                </span>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-border/70 bg-background p-2.5 flex flex-col justify-between">
              ...
              <div className="mt-1">
                <span className="text-lg font-bold tracking-tight text-foreground">{vitalSigns.spo2}</span>
          ...
          <div className="mt-4 space-y-2.5 border-t border-border pt-3.5 text-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <div className="rounded-lg bg-muted/30 p-2.5">
                ...
                <p className="text-muted-foreground text-[11px] mt-0.5">{physicalExamFindings.throat}</p>
              </div>

              <div className="rounded-lg bg-muted/30 p-2.5">
                <p className="font-semibold text-foreground text-[11px]">Hô hấp (Phổi)</p>
                <p className="text-muted-foreground text-[11px] mt-0.5">{physicalExamFindings.lungs}</p>
              </div>

              <div className="rounded-lg bg-muted/30 p-2.5">
                <p className="font-semibold text-foreground text-[11px]">Tim mạch</p>
                <p className="text-muted-foreground text-[11px] mt-0.5">{physicalExamFindings.heart}</p>
              </div>

              <div className="rounded-lg bg-muted/30 p-2.5">
                <p className="font-semibold text-foreground text-[11px]">Tiêu hóa & Bụng</p>
                <p className="text-muted-foreground text-[11px] mt-0.5">{physicalExamFindings.abdomen}</p>
              </div>
              ...
              <div className="col-span-1 sm:col-span-2 rounded-lg bg-muted/30 p-2.5">
                ...
                <p className="text-muted-foreground text-[11px] mt-0.5">{physicalExamFindings.otherFindings}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="lg:col-span-5 space-y-6">
        ...
        <div className="rounded-lg border border-border bg-card p-6 ">
          ...
          <div className="mt-4 space-y-2.5">
            {diagnosticServiceRequests.slice(0, 4).map((order) => (
              <div
                key={order.id}
          ...
          <div className="mt-4 space-y-3.5 text-xs">
            ...
            <div className="rounded-lg bg-primary/5 p-3 border border-primary/15">
              ...
              <p className="mt-1 text-foreground/90 leading-relaxed">
                {assessmentAndPlan.patientInstructions}
              </p>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border/70">
              ...
              <span className="inline-flex items-center gap-1.5 font-semibold text-foreground">
                ...
                {assessmentAndPlan.followUpDate}
              </span>
            </div>
          </div>
        </div>
