...
describe("Encounter Detail Screens", () => {
  ...
  it("Screen 04 — EncounterDiagnosticOrdersView renders 7 services matching reference", () => {
    renderWithClient(
  ...
  it("Screen 05 — EncounterLaboratoryDetailView renders 10 indicators with reference ranges", () => {
    renderWithClient(
