...
import { usePopulateSampleParticipants } from "../hooks/use-health-examination-batches"
...
export function ImportParticipantsDialog({
  ...
  const { mutateAsync: populateSample, isPending } = usePopulateSampleParticipants()
  ...
  const handleImport = async () => {
    setError(null)
    if (!selectedFile) {
      setError("Vui lòng chọn file danh sách người khám để import.")
      return
    }
